...
Generado automáticamente: 2026-09-22 16:13 UTC. Fuente única para redactar posts — ya viene filtrado y no hace falta leer los CSVs completos.
...
| Rol | Jugador | Equipo | Pos | Precio | xP | Techo | P(haul) | xP 4GW | Próximo rival | Balón parado |
|---|---|---|---|---|---|---|---|---|---|---|
| **Capitán** | Groß | Brighton | MID | £5.8m | 11.2 | 7.0 | 3% | 8.3 | Sunderland (fuera) | Penales, Tiros libres, Córners |
...
| Banco 2 | Diop | Ipswich Town | DEF | £4.0m | 2.5 | 6.0 | 2% | 9.31 | Fulham (casa) | — |
| Banco 3 | Hughes | Crystal Palace | MID | £4.4m | 0.5 | 2.0 | 0% | 3.26 | Nott'm Forest (casa) | — |
| Banco 4 | Georginio | Brighton | FWD | £5.3m | 0.2 | 5.0 | 0% | 3.41 | Sunderland (fuera) | — |

## Mejores opciones de capitanía

| Jugador | Equipo | Pos | xP | Techo | P(haul) | Propiedad | Rival |
|---|---|---|---|---|---|---|---|
| Groß | Brighton | MID | 11.2 | 7.0 | 3% | 27.5% | Sunderland |
...
| Isak | Liverpool | FWD | 7.8 | 6.0 | 2% | 22.3% | Man City |
| Semenyo | Man City | MID | 7.8 | 7.0 | 2% | 15.4% | Liverpool |
...
|---|---|---|---|---|---|---|---|---|
| Bogle | Leeds | DEF | £4.6m | 6.8% | 9.0 | 6.0 | 1% | Arsenal |
| Scott | Bournemouth | MID | £6.1m | 5.7% | 7.0 | 5.0 | 1% | Chelsea |
| Barnes | Newcastle | MID | £6.1m | 5.4% | 6.5 | 8.0 | 6% | Coventry City |
...
- **xP**: puntos esperados del próximo gameweek. Desde GW6 es `ep_next`, la estimación que publica la propia FPL, y no el motor de este repo: medido sobre GW4 y GW5 ordenaba mucho mejor (Spearman 0.625 contra 0.353), así que se adoptó. Incluye bonus points, que el motor propio no modela. **Cuidado:** no está claro que descuente del todo las lesiones reportadas, así que un jugador en duda puede figurar más alto de lo que corresponde — chequear la columna de estado antes de recomendarlo. El motor propio sigue disponible como `xp_model` en `players_scored.csv`, para comparar.
